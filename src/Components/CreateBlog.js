        ...
        <>
            ...
            <div className='bg-slate-400 mt-10'>
                ...
                <div>
                    ...
                    {/* <button onClick={onSubmitImg}>submit</button> */}
                </div>
            </div>
            {/* <div>
                <h4>Chose and click which one eyou like</h4>
                <select name="BlogFormat" id="BlogFormat" className='bg-slate-400'>
                <option value="BlogFormat1" className='h-64'><button className='h-36 w-36 border-2 border-black m-7' onClick={onSubmitImg}><Link to="/BlogFormat1">
                    {<div>
                        <h2>BlogTitle</h2>
